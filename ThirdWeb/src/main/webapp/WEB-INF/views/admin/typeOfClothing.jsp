		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/toc">Type of clothing</a><span
...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
			...
			<div class="col-md-12 col-xs-12">
				<form class="form-horizontal" action="/admin/toc" method="POST">
					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label">Type of clothing</label>
    					<div class="col-sm-10">
      						<input type="text" class="form-control" name="itemType" id="name">
    					</div>
  					</div>
  					<div class="form-group">
...
<!-- 					тут все так само як на сервлетах -->
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/toc/update/${typeOfClothing.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/toc/delete/${typeOfClothing.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
